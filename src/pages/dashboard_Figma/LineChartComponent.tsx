...
const LineChartComponent = ({ year2021, year2023, year2022 }: TStats) => {
  ...
  const startDate2023 = new Date("2024-03-03");
  ...
  // Calculate total values
  const combinedTotalNewCustomers = calculateTotalCustmers(
              ...
              {combinedFilteredData.length === 0 ? (
                <ResponsiveContainer height={300}>
                  ...
                  >
                    ...
                    <Tooltip
                      content={
                        <CustomTooltip data={[...year2022, ...year2023]} />
                      }
                      wrapperStyle={{
                        backgroundColor: "#fff",
                    ...
                    <Legend
                      content={<DatesRange data={[...year2022, ...year2023]} />}
                    />
                ...
                <ResponsiveContainer height={300}>
                  ...
                  >
                    ...
                    <Tooltip
                      content={
                        <CustomTooltip
                          data={[...year2023, ...year2022, ...year2021]}
                        />
                      }
                      wrapperStyle={{
                        backgroundColor: "#fff",
                    ...
                    <Legend
                      content={<DatesRange data={combinedFilteredData} />}
                    />
                    <Line
                      type="monotone"
                      dataKey="sale_cost"
